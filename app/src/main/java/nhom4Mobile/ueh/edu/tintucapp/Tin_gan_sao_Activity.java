...
public class Tin_gan_sao_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Lấy và hiển thị tất cả bài viết với trạng thái favor = true
        loadArticles();
    }

    private void loadArticles() {
        db.collection("new")
                .whereEqualTo("favor", true) // Lọc bài viết có trạng thái favor = true
                .get()
    ...
    private void displayArticle(String title, String content, String imageUrl, LinearLayout articlesContainer, boolean isFavorited, boolean isSaved, String documentId) {
        ...
        Picasso.get().load(imageUrl).into(newsImage, new Callback() {
            ...
            public void onError(Exception e) {
                ...
                Toast.makeText(Tin_gan_sao_Activity.this, "Không thể tải hình ảnh", Toast.LENGTH_SHORT).show();
            }
        });
